...
DEFAULT_TIMEOUT = int(os.getenv("VT_QUERY_TIMEOUT", "60"))
DEFAULT_MAX_RETRIES = int(os.getenv("VT_QUERY_MAX_RETRIES", "4"))
DEFAULT_BACKOFF_SECONDS = float(os.getenv("VT_QUERY_RETRY_BACKOFF", "1.5"))
