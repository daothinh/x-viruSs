...
from apis.sysinternals_vt_batch_pipeline import BatchQueryConfig, iter_input_records, run_batch_query
...
class VTRequestHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        requested_hashes = [item["hash"] for item in __import__("json").loads(payload)]
            ...
            response_rows.append(
                {
                    "hash": hash_value,
                    "found": True,
                    "detection_ratio": "5/76"
                    if hash_value == "44d88612fea8a8f36de82e1278abb02f"
                    else "11/76",
                }
            )

        response_body = __import__("json").dumps({"data": response_rows}).encode("utf-8")
...
class SysinternalsVTPipelineTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.base_url = f"http://127.0.0.1:{cls.server_port}/query"
    ...
    def test_response_mapping_is_hash_keyed_not_position_keyed(self):
        response_data = {
            "data": [
                {"hash": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", "found": True, "detection_ratio": "10/76"},
                {"hash": "44d88612fea8a8f36de82e1278abb02f", "found": False},
            ]
        }
        self.assertEqual(
            map_detection_ratios(
                response_data,
                [
            ...
            ),
            {
                ...
                "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa": "10/76",
            },
        )
